...
public:
    ...
    {
        return this->tx_->getFieldObject(sfRawTransaction);
    }
...
public:
    ...
    TransactionProposalCreateBuilder(SF_ACCOUNT::type::value_type account,
                     STObject const& rawTransaction,                     std::decay_t<typename SF_UINT32::type::value_type> const& expiration,                    std::optional<SF_UINT32::type::value_type> sequence = std::nullopt,
