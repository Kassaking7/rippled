...
class PermissionedDEX_test : public beast::unit_test::suite
{
    ...
    testHybridInvalidOffer(FeatureBitset features)
    {
        ...
        if (features[fixSecurity3_1_3])
        {
            ...
            BEAST_EXPECT(checkOffer(
                env, bob, hybridOfferSeq, XRP(45), USD(45), lsfHybrid, true));
            ...
            auto const openDir =
                sleHybridOffer->getFieldArray(sfAdditionalBooks)[0]
                    .getFieldH256(sfBookDirectory);
            ...
            BEAST_EXPECT(checkOffer(
                env, bob, hybridOfferSeq, XRP(40), USD(40), lsfHybrid, true));
            BEAST_EXPECT(
                checkOffer(env, bob, regularOfferSeq, XRP(10), USD(10)));
            BEAST_EXPECT(checkDirectorySize(env, openDir, 2));
        }
    ...
    testHybridOpenBookAfterCredentialExpiry(FeatureBitset features)
    {
        ...
        BEAST_EXPECT(checkOffer(
            env, devin, hybridOfferSeq, XRP(10), USD(10), lsfHybrid, true));
        ...
        BEAST_EXPECT(env.balance(carol, USD) - carolBalBefore == USD(5));
        BEAST_EXPECT(checkOffer(
            env, devin, hybridOfferSeq, XRP(5), USD(5), lsfHybrid, true));
        ...
        BEAST_EXPECT(checkOffer(
            env, devin, hybridOfferSeq, XRP(3), USD(3), lsfHybrid, true));
